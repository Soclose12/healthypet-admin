      ...
      <div>
         ...
         <div className="tiles-grid">
            <div className="tile">
               ...
               <div className="tile-desc">{ordersToday.length} Замовлення сьогоні</div>
            </div>
            <div className="tile">
               <h3 className="tile-header">Цей тиждень</h3>
               <div className="tile-number">{ordersWeek.length}</div>
               <div className="tile-desc">{ordersWeek.length} замовлення за цей тиждень</div>
            </div>
            <div className="tile">
               <h3 className="tile-header">Цей місяць</h3>
               <div className="tile-number">{ordersMonth.length}</div>
               <div className="tile-desc">{ordersMonth.length} Замовлення за цей місяць</div>
            </div>
         </div>
         <h2>Дохід</h2>
         <div className="tiles-grid">
            <div className="tile">
               ...
               <div className="tile-desc">{ordersToday.length} замовлення сьогодні</div>
            </div>
            <div className="tile">
               <h3 className="tile-header">Цього тижня</h3>
               <div className="tile-number">$ {ordersTotal(ordersWeek)}</div>
               <div className="tile-desc">{ordersWeek.length} замовлень цього тижня</div>
            </div>
            <div className="tile">
               <h3 className="tile-header">Цього місяця</h3>
               <div className="tile-number">$ {ordersTotal(ordersMonth)}</div>
               <div className="tile-desc">{ordersMonth.length} замовлень цього місяця</div>
            </div>
         </div>
      </div>
   );
